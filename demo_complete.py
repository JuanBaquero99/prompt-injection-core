#!/usr/bin/env python3
"""
🧪 DEMO COMPLETA - Prompt Injection Core v0.2.0
...
def demo_basic_functionality():
    ...
    # Scanner básico (solo reglas)
    scanner_basic = PromptScanner()
    
    # Scanner con ML
    scanner_ml = PromptScanner(use_ml=True)
    
    # Scanner completo (ML + Experimental)
    scanner_full = PromptScanner(use_ml=True, use_experimental=True)
